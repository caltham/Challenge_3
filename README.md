...
~~~
Note: "x" is in place of the dollar sign.
...
~~~
**Note:** As you can see above, users have the ability to choose columns of data through different methods.
...
~~~
**Note:** Creates a line plot for the bitstamp DataFrame for the full length of time in the dataset.
...
~~~
**Note:** Creates a line plot for the coinbase DataFrame for the full length of time in the dataset.
...
~~~
**Note:** Overlays the visualizations for the bitstamp and coinbase DataFrames in one plot. The plot should visualize the prices over the full lenth of the dataset
...
~~~
**Note:** Creates an overlay plot that visualizes the price action of both DataFrames for a one month period. By narrowing the focus of the plot, users have the ability to make a more informed analysis of the data.
...
~~~
**Note:** Creates an overlay plot that visualizes the price action of both DataFrames for a one day period. By narrowing the focus of the plot, users have the ability to make a more informed analysis of the data.
...
~~~
**Note:** Calculates the arbitrage spread by subtracting the bitstamp lower closing prices from the coinbase higher closing prices.

~~~
arbitrage_spread_early.describe()
~~~
**Note:** Generates summary statistics for the DataFrame.
...
~~~
**Note:** Visualizes the arbitrage spread in a box plot.
...
~~~
**Note:** Uses a conditional statement to generate the summary statistics for the arbitrage_spread DataFrames where the spread is greater than 0.
...
~~~
**Note:** Calculates the spread returns by dividing the instances when the arbitrage spread is positive (> 0) by the price of Bitcoin from the exchange you are buying on (the lower-priced exchange).

~~~
profitable_trades_early = spread_return_early[spread_return_early > .01]
~~~
**Note:** Determines the number of times your trades with positive returns exceed the 1% minimum threshold (.01) that you need to cover your costs.

~~~
profit_early = profitable_trades_early * bitstamp_sliced['Close'].loc['2018-01-01']
profit_per_trade_early = profit_early.dropna()
~~~
**Note:** Calculates the potential profit per trade in dollars by multiplying the profitable trades by the cost of the Bitcoin that was purchased.

~~~
profit_per_trade_early.describe()
~~~
**Note:** Generates the summary statistics for the profit per trade DataFrame.
...
~~~
**Note:** Plots the results for the profit per trade DataFrame.
...
~~~
**Note:** Calculates the sum of the potential profits for the profit per trade DataFrame.

~~~
cumulative_profit_early = profit_per_trade_early.cumsum()
~~~
**Note:** Calculates the cumulative profits over time for the profit per trade DataFrame.

~~~
cumulative_profit_early.plot(figsize=(15, 8), title="Bitcoin Profits")
~~~
**Note:** Plots the cumulative sum of profits for the profit per trade DataFrame.
